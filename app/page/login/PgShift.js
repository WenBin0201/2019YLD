        ...
        return (
            <View style={PublicStyle.bg}>
                <View style={PublicStyle.navigator}>
                    ...
                    <Text style={PublicStyle.text_FFF_30}>交接班</Text>
                ...
                <View style={[PublicStyle.ajcjf]}>
                    <View style={[ShiftStyle.ShiftStyle_view1]}>
                        <Text style={PublicStyle.text_2B7888_16}>店铺名称：{this.state.shopName}</Text>
                        ...
                        <View style={{ flexDirection: 'row', width: 570, }}>
                            <Button width={222} height={30} backgroundColor={COLOR_F19149} fontSize={18} text={'打印交接班结果'} style={{ flex: 1, marginRight: 15 }} />
                            <Button width={222} height={30} backgroundColor={COLOR_E74C39} fontSize={18} text={'交接班并退出'} style={{ flex: 1, marginLeft: 15 }} />
                        </View>
                    </View>
                </View>
        ...
        return (
            <View style={[ShiftStyle.ShiftStyle_view4,{marginLeft:10}]}>
                <View style={ShiftStyle.ShiftStyle_view5}>
                    <Text style={PublicStyle.text_2B7888_14}>{str1}</Text>
                    <Text style={[PublicStyle.text_2B7888_14,{fontWeight:'bold'}]}>{params1 ? params1 + '￥' : ''}</Text>
                </View>
                <View style={{ flex: 1 }}>
                    <Text style={PublicStyle.text_9E9E9E_10}>{str2}：{params2}</Text>
                    <Text style={PublicStyle.text_9E9E9E_10}>{str3}：{params3}</Text>
                </View>
            </View>
        )
    }
    ...
    _renderLeftCell = (item = {},str1='', str2='', str3='') => {
        ...
        return (
            <View style={[ShiftStyle.ShiftStyle_view4,{marginRight:10}]}>
                <View style={ShiftStyle.ShiftStyle_view5}>
                    <Text style={PublicStyle.text_2B7888_14}>{str1}</Text>
                    <Text style={[PublicStyle.text_2B7888_14,{fontWeight:'bold'}]}>{(params1 && str1!='总销售单(笔)') ? params1 + '￥':params1}</Text>
                </View>
                <View style={{ flex: 1 }}>
                    <Text style={PublicStyle.text_9E9E9E_10}>{str2?str2+':':''}{params2}</Text>
                    <Text style={PublicStyle.text_9E9E9E_10}>{str3?str3+':':''}{params3}</Text>
                </View>
            </View>
        )
    }
